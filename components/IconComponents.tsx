...
export const PlantIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 21a2 2 0 002 2h2a2 2 0 002-2v-2H9v2z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 14h6" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 14v-4" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 10c-1.5 0-3-1-3-3.5a2.5 2.5 0 115 0c0 2.5-1.5 3.5-3 3.5z" />
  </svg>
);

export const CrownIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 120 100" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
    <path d="M10 95 L15 45 L40 65 L60 30 L80 65 L105 45 L110 95 Z" stroke="currentColor" strokeWidth="10" strokeLinejoin="round" strokeLinecap="round" fill="none"/>
...
export const PajamaIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
